...
p1 = Job.new(company: 'Project 1', engineers: [steve])
p2 = Job.new(company: 'Project 2',engineers: [ali])
p3 = Job.new(company: 'Project 3', engineers: [bruno])
p4 = Job.new(company: 'Project 4', engineers: [david])

# p1.engineers=(steve, corey, tara, jordan, soleil)
# p2.engineers=(ali, corey, tara, jordan, soleil)
# p3.engineers=(bruno, corey, tara, jordan, soleil)
# p4.engineers=(david, corey, tara, jordan, soleil)